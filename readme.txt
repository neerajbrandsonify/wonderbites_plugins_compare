...
== Description ==
The WooCommerce Extra Product Options (WooCommerce Product Addons) plugin lets you add custom product fields(14 field types) and sections to your product page, making your WooCommerce product page more functional.
...
Add advanced fields to the product page with Extra Product Options. 14 custom product fields help you to showcase a wider variety of products and options that work for almost every kind of WooCommerce store.
