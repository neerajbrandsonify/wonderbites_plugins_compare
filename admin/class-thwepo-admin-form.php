...
abstract class THWEPO_Admin_Form {
	...
	private function render_form_field_element_checkbox($field, $atts = array(), $render_cell = true){
		...
		if($field && is_array($field)){
			...
			if($tooltip){
				$field_html .= '<a href="javascript:void(0)" title="'. $tooltip .'" class="thwepo_tooltip" style="float:none;"><img src="'. THWEPO_ASSETS_URL_ADMIN .'/css/help.png" title=""/></a>';
			}
		}
        ...
        <tr>
        	<td class="">
                <select name="i_rules_action" class="rule-action">
                    <option value="show"><?php _e('Show', 'woocommerce-extra-product-options-pro');?></option>
                    <option value="hide"><?php _e('Hide', 'woocommerce-extra-product-options-pro');?></option>
                </select>
                <?php 
                /* translators: %s: popup type */
                echo sprintf(__('%s if all below conditions are met.' , 'woocommerce-extra-product-options-pro'), $type); 
                ?>
            </td>
        </tr>
        <tr>                
                                                        ...
                                                        <tr class="thwepo_condition">
                                                            <td class="operand-type">
                                                                <select name="i_rule_operand_type" onchange="thwepoRuleOperandTypeChangeListner(this)">
                                                                    <option value=""></option>
                                                                    <option value="product"><?php _e('Product', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="category"><?php _e('Category', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="tag"><?php _e('Tag', 'woocommerce-extra-product-options-pro');?></option>
																	<option value="user_role"><?php _e('User role', 'woocommerce-extra-product-options-pro');?></option>
                                                                </select>
                                                            </td>
                                                            <td class="operator">
                                                                <select name="i_rule_operator">
                                                                    <option value=""></option>
                                                                    <option value="equals"><?php _e('Equals to/ In', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="not_equals"><?php _e('Not Equals to/ Not in', 'woocommerce-extra-product-options-pro');?></option>
                                                                </select>
                                                            </td>
                                                        ...
                                                        <tr class="thwepo_condition">
                                                            ...
                                                            <td class="operator">
                                                                <select name="i_rule_operator" onchange="thwepoRuleOperatorChangeListnerAjax(this)">
                                                                    <option value=""></option>
                                                                    <option value="empty"><?php _e('Is empty', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="not_empty"><?php _e('Is not empty', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_eq"><?php _e('Value equals to', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_ne"><?php _e('Value not equals to', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_in"><?php _e('Value in', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_cn"><?php _e('Contains', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_nc"><?php _e('Not contains', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_gt"><?php _e('Value greater than', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_le"><?php _e('Value less than', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_sw"><?php _e('Value starts with', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="value_nsw"><?php _e('Value not starts with', 'woocommerce-extra-product-options-pro');?></option>
																	<option value="date_eq"><?php _e('Date equals to', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="date_ne"><?php _e('Date not equals to', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="date_gt"><?php _e('Date after', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="date_lt"><?php _e('Date before', 'woocommerce-extra-product-options-pro');?></option>
																	<option value="day_eq"><?php _e('Day equals to', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="day_ne"><?php _e('Day not equals to', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="checked"><?php _e('Is checked', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="not_checked"><?php _e('Is not checked', 'woocommerce-extra-product-options-pro');?></option>
                                                                    <option value="regex"><?php _e('Match expression', 'woocommerce-extra-product-options-pro');?></option>
                                                                </select>
                                                            </td>
                                                            <td class="value">
	...
	private function render_field_form_fragment_fields_select(){		
		...
		?>
        <select multiple="multiple" name="i_rule_operand" data-placeholder="<?php _e('Click to select field(s)', 'woocommerce-extra-product-options-pro');?>" class="thwepo-enhanced-multi-select" value="" style="width: 98%;">
	...
	public function render_field_form_fragment_product_list(){
		?>
        <div id="thwepo_product_select" style="display:none;">
        <select multiple="multiple" name="i_rule_operand" data-placeholder="<?php _e('Click to select products', 'woocommerce-extra-product-options-pro');?>" class="thwepo-enhanced-multi-select1 thwepo-operand thwepo-product-select" value="" style="width: 98%;">
        </select>
        </div>
        <?php
	}
    ...
    public function render_field_form_fragment_category_list(){        
		...
		if(!empty($categories)){		
	        ...
	        <select multiple="multiple" name="i_rule_operand" data-placeholder="<?php _e('Click to select categories', 'woocommerce-extra-product-options-pro');?>" class="thwepo-enhanced-multi-select thwepo-operand" value="" style="width: 98%;">
				<?php 	
	...
	public function render_field_form_fragment_tag_list(){
		...
		if(!empty($tags)){		
	        ...
	        <select multiple="multiple" name="i_rule_operand" data-placeholder="<?php _e('Click to select tags', 'woocommerce-extra-product-options-pro');?>" class="thwepo-enhanced-multi-select thwepo-operand" value="" style="width: 98%;">
				<?php 	
	                foreach($tags as $tag){
	...
	public function render_field_form_fragment_user_role_list(){		
        ...
        <select multiple="multiple" name="i_rule_operand" data-placeholder="<?php _e('Click to select user roles', 'woocommerce-extra-product-options-pro');?>" class="thwepo-enhanced-multi-select" value="" style="width: 98%;">
			<?php 	
